...
urlpatterns = patterns('radio_stream.playlist.views',
    ...
    url(r"^played/(?P<user>\w+)/$", 'played_by_name', name="radio-played-user"),
    url(r"^played/(?P<user>\w+)/(?P<page>\d+)/$", 'played_by_name', name="radio-played-user-pagination"),
    ...
    url(r"^queue/(?P<user>\w+)/(?P<page>\d+)/$", "queue_by_name", name="radio-queue-user-pagination"),
)
